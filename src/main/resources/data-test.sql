...
INSERT INTO Ofertante (id, name, last_name, phone, birthday,reputation, reputation_value, empresa_id, created_at) VALUES
                                                                                                              (1, 'Alice', 'Brown',  '555-0101', '1985-04-12','BAJA', 5, 1, NOW()),
                                                                                                              (2, 'Bob', 'Smith',  '555-0102', '1990-06-15', 'ALTA', 100, 2, NOW())On conflict do nothing;
...
INSERT INTO Job_offers (id, title, description, requirements, logo, location, created_at, salary, benefits, status, job_modality_id, ofertante_id) VALUES
                                                                                                                                                       ...
                                                                                                                                                       (2, 'Data Scientist', 'Analyze data to provide insights.', 'Python, SQL', 'logo2.png', 'San Francisco', '2024-09-05T09:00:00', 90000, 'Health insurance, stock options', 'INACTIVE', 2, 1),
...
INSERT INTO Postulante (id, name, last_name, phone, birthday,created_at, active) VALUES
                                                                                  (1, 'John', 'Doe', '555-0103', '1992-07-21',NOW(), TRUE),

                                                                                  (2, 'Jane', 'Doe',  '555-0104', '1993-08-22',NOW(), TRUE) On conflict do nothing;
...
INSERT INTO Postulacion (id, estado, fecha_aplicacion, postulante_id, oferta_laboral_id) VALUES
                                                                                             (1, 'Pendiente', '2024-09-10', 2, 1),
                                                                                             (2, 'Aprobado', '2024-09-11', 1, 2),
                                                                                             (3, 'Cancelado', '2024-09-12', 2, 2)ON CONFLICT DO NOTHING;
